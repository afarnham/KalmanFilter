...
public struct KalmanFilter<Type: KalmanInput>: KalmanFilterType {
     ...
     */
    public func predict(_ stateTransitionModel: Type, controlInputModel: Type, controlVector: Type, covarianceOfProcessNoise: Type) -> KalmanFilter {
     ...
     */
    public func update(_ measurement: Type, observationModel: Type, covarienceOfObservationNoise: Type) -> KalmanFilter {
